...
export default function HeroAssinatura() {
  return (
    ...
    >
      ...
      <div className="max-w-[1400px] w-full px-[48px] relative flex items-center">
          ...
          <div className="flex flex-col items-start gap-[20px] z-10 py-12 lg:py-0">
            <ScrollAnimation>
              ...
              <div className="flex flex-col gap-[20px] mt-2">
                <h1 className="text-[48px] font-bold text-[#1a1a1a] leading-[55px] tracking-[-0.03em] max-w-[584px]">
                  Assine eletronicamente seus documentos pelo Whatsapp
                </h1>
                <p className="text-[18px] font-semibold text-[#1a1a1a] opacity-70 leading-[150%] max-w-[484px]">
                  Elimine processos manuais do RH. Envie holerites diretamente para o WhatsApp dos colaboradores em minutos.
                </p>
              </div>

              {/* Botões (Frame 2) */}
              <div className="flex flex-row items-center gap-[10px] mt-8">
                <Link
                  href="#contato"
                  className="bg-[#004DFF] text-[#F8F8FE] h-[56px] px-[32px] rounded-[90px] font-medium text-[16px] flex items-center gap-[10px] hover:opacity-90 transition-all group"
                >
                  Fale Conosco
                ...
                <Link
                  href="#demo"
                  className="bg-[#262626] text-[#F8F8FE] h-[56px] px-[32px] rounded-[90px] font-medium text-[16px] flex items-center gap-[10px] hover:opacity-90 transition-all group"
                >
                  Agendar Demo
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                    <line x1="7" y1="17" x2="17" y2="7"></line>
