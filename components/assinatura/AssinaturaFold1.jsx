export default function AssinaturaFold2() {
  ...
  return (
    ...
    >
      <div className="max-w-[1400px] w-full px-[48px] flex flex-col items-center">
        ...
        <div className="w-full max-w-[1100px] flex flex-col gap-[60px] items-center">
          ...
          <div className="grid md:grid-cols-2 gap-[22px] w-full">
             {cards.map((card, index) => (
               <div 
                 key={index} 
                 className="bg-[#F8F8FE] border border-[#7CA3FD] rounded-[20px] p-[20px] flex flex-col gap-[32px] h-[216px]"
               >
          ...
          <div className="w-full max-w-[980px] bg-[#004DFF] border border-[#E0E9FE] rounded-[20px] p-[40px] flex flex-row items-center gap-[20px]">
            ...
            <p className="text-[#F8F8FE] text-[28px] font-semibold leading-[32px] tracking-[-0.03em] flex-1">
