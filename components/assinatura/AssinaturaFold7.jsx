          ...
          <div className="flex flex-col justify-center items-center gap-5 px-6 py-10 md:px-[80px] md:py-[60px] max-w-full md:max-w-[600px] z-10 text-center w-full">
            <div>
              ...
              <div className="flex flex-col gap-5">
                <h2 className="text-[28px] md:text-[36px] font-bold text-[#1a1a1a] leading-[1.15] md:leading-[42px] tracking-[-0.03em] max-w-[420px]">
                  Pronto para transformar o RH da sua empresa?
                </h2>
                <p className="text-[#1a1a1a] opacity-70 text-[16px] font-semibold leading-[150%] max-w-[420px]">
