          ...
          <div className="flex flex-col gap-[53px] w-full">
            {steps.map((step, index) => (
              <div key={index} className="flex flex-col gap-[10px]">
                ...
                <div 
                  className="w-[474px] h-[461.44px] rounded-[20px] relative isolate overflow-visible flex flex-col p-[20px] gap-[12px]"
                ...
                >
                  ...
                  <div className="flex flex-col items-start gap-0 z-[1] mt-2">
                    ...
                    <h3 className="text-[28px] font-semibold text-[#1a1a1a] leading-[32px] tracking-[-0.03em]">
                      {step.title}
                    </h3>
                    <p className="text-[#1a1a1a] opacity-70 text-[18px] font-semibold leading-[150%] max-w-[434px]">
                      {step.description}
                    </p>
                  </div>
                </div>
