...
export default function AssinaturaFold7() {
  ...
  return (
    <section className="bg-[#F8F8FE] py-[60px] flex justify-center w-full" id="faq">
      <div className="max-w-[1400px] w-full px-[48px]">
              ...
              >
                <div className="flex justify-between items-center gap-5">
                  ...
                  <h4 className={`text-[20px] font-semibold leading-[24px] tracking-[-0.03em] flex-1 transition-colors ${
                    openIndex === index ? 'text-[#004DFF]' : 'text-[#1a1a1a]'
                  }`}>
                    {faq.question}
                  </h4>
                  {/* Chevron Icon */}
                  <div className={`transition-transform duration-300 flex-shrink-0 ${openIndex === index ? 'rotate-180' : ''}`}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={openIndex === index ? "#004DFF" : "#1a1a1a"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                {openIndex === index && (
                  <div className="mt-4 animate-in fade-in slide-in-from-top-2 duration-300">
                    <p className="text-[#666] text-[16px] font-medium leading-[150%]">
                      {faq.answer}
                    </p>
                  </div>
                )}
