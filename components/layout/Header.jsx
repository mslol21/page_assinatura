        ...
        <nav className="hidden lg:flex items-center gap-[20px] flex-1 justify-center">
          {['Home', 'Como Funciona', 'Benefícios', 'Preços', 'FAQ'].map((item) => (
            <Link
              ...
              className="text-[#1a1a1a] font-medium hover:text-[#0066FF] transition-colors duration-300 text-[16px] whitespace-nowrap"
            >
              {item}
            </Link>
          ))}
          ...
          >
            <div className="flex items-center gap-1 text-[#1a1a1a] font-medium hover:text-[#0066FF] transition-colors text-[16px]">
               Páginas 
               <svg 
                 width="12" 
                 height="12" 
            ...
            <div className={`absolute top-full left-1/2 -translate-x-1/2 pt-4 w-[200px] transition-all duration-200 ${pagesMenuOpen ? 'opacity-100 visible translate-y-0' : 'opacity-0 invisible translate-y-[10px]'}`}>
              <div className="bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden p-2 flex flex-col gap-1">
                <Link 
                  href="/" 
                  className="px-4 py-2 hover:bg-gray-50 rounded-lg text-sm font-medium text-gray-700 hover:text-[#0066FF] transition-colors block text-center"
                >
                  Home
                </Link>
                <Link 
        ...
        <div className="flex-shrink-0 flex items-center gap-[12px] z-10">
          <div className="hidden sm:flex items-center gap-[8px]">
            <Link
              ...
              className="h-[40px] px-5 rounded-full font-semibold bg-[#0066FF] text-white hover:bg-[#0052CC] transition-all flex items-center gap-2 text-[14px] whitespace-nowrap"
            >
              Fale Conosco
            ...
            <Link
              href="#demo"
              className="h-[40px] px-5 rounded-full font-semibold border-[1.5px] border-[#0066FF] text-[#0066FF] hover:bg-[#f0f7ff] transition-all flex items-center gap-2 text-[14px] whitespace-nowrap"
            >
              Agendar Demo
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <line x1="7" y1="17" x2="17" y2="7"></line>
